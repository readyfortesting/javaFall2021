...
public class C01_MethodCreation {
	...
	public static void main(String[] args) {
		...
		// iki farkli method olusturun,methodlardan biri girilen kelimeleri  ilk harf buyuk
		// digerleri kucuk olacak sekilde birlestirsin
		// 2.method isim ve soyismin ilk harfleri buyukharf,kalan harfler * olacak sekilde birlestirsin.
		// Kullaniciya isminin acik olarak yazilmasi veya gizlenmesi tercihi sorun
		// ve programin kalan kisminda isim ve soyismi kullanicinin istedigi

		
		
		
	// isim soyismi alacak,iil harfleri buyuk harf kalan harfler kucuk olarak birlestirecek
		                        // 2.adim parantez icine : isim soyisim yazdik
		                        // 3.adim altina tiklayip method yapariz
								//4.adim Access modifier secimi : public mi private mi ?				
